/**
 * Página de Listagem de Vinhos Tintos
 * 
 * Esta página exibe todos os vinhos tintos disponíveis na loja,
...
// Dados mockados de vinhos tintos
...
const availableCountries = ['Argentina', 'Chile', 'Portugal', 'Itália', 'França', 'Uruguai'];

// Anos disponíveis para filtro
const availableYears = [2015, 2016, 2017, 2018, 2019, 2020];

// Tipos de vinho tinto disponíveis para filtro
const availableTypes = ['Malbec', 'Cabernet Sauvignon', 'Blend', 'Sangiovese', 'Pinot Noir', 'Carménère', 'Tannat'];
...
export default function RedWinesPage() {
  ...
  const filteredProducts = redWines.filter(product => {
    // Filtro por preço
  ...
  return (
    <main className="container mx-auto px-4 py-8 mt-[60px] md:mt-[80px]">
      {/* Cabeçalho da página */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Vinhos Tintos</h1>
        <p className="text-gray-600">
          Explore nossa seleção premium de vinhos tintos, desde Malbecs encorpados até elegantes Pinot Noirs.
        </p>
      </div>
