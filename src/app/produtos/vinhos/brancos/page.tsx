/**
 * Página de Listagem de Vinhos Brancos
 * 
 * Esta página exibe todos os vinhos brancos disponíveis na loja,
...
// Dados mockados de vinhos brancos
const whiteWines: Product[] = [
  {
    id: '1',
    name: 'Chardonnay Reserva 2021',
    price: 159.90,
    oldPrice: 189.90,
    image: defaultImage,
    slug: 'chardonnay-reserva-2021',
    country: 'Brasil',
    year: 2021,
    rating: 4.5,
    type: 'Chardonnay',
  ...
  {
    id: '2',
    name: 'Sauvignon Blanc Premium 2022',
    price: 129.90,
    image: defaultImage,
    slug: 'sauvignon-blanc-premium-2022',
    country: 'Chile',
    year: 2022,
    rating: 4.3,
  ...
  {
    id: '3',
    name: 'Riesling Alemão 2020',
    price: 219.90,
    oldPrice: 249.90,
    image: defaultImage,
    slug: 'riesling-alemao-2020',
    country: 'Alemanha',
    year: 2020,
    rating: 4.7,
    type: 'Riesling'
  ...
  {
    id: '4',
    name: 'Pinot Grigio Italiano 2021',
    price: 179.90,
    image: defaultImage,
    slug: 'pinot-grigio-italiano-2021',
    country: 'Itália',
    year: 2021,
    rating: 4.2,
    type: 'Pinot Grigio'
  ...
  {
    id: '5',
    name: 'Gewürztraminer Alsace 2019',
    price: 249.90,
    image: defaultImage,
    slug: 'gewurztraminer-alsace-2019',
    country: 'França',
    year: 2019,
    rating: 4.6,
    type: 'Gewürztraminer'
  ...
  {
    id: '6',
    name: 'Chenin Blanc Sul-Africano 2022',
    price: 139.90,
    oldPrice: 159.90,
    image: defaultImage,
    slug: 'chenin-blanc-sul-africano-2022',
  ...
  {
    id: '7',
    name: 'Viognier Reserva 2020',
    price: 189.90,
    image: defaultImage,
    slug: 'viognier-reserva-2020',
    country: 'Argentina',
    year: 2020,
    rating: 4.3,
    type: 'Viognier'
  ...
  {
    id: '8',
    name: 'Albariño Espanhol 2021',
    price: 169.90,
    image: defaultImage,
    slug: 'albarino-espanhol-2021',
    country: 'Espanha',
    year: 2021,
    rating: 4.5,
    type: 'Albariño',
...
const availableCountries = ['Brasil', 'Chile', 'Argentina', 'França', 'Itália', 'Espanha', 'Alemanha', 'África do Sul'];

// Anos disponíveis para filtro
const availableYears = [2019, 2020, 2021, 2022, 2023];

// Tipos de vinho branco disponíveis para filtro
const availableTypes = ['Chardonnay', 'Sauvignon Blanc', 'Riesling', 'Pinot Grigio', 'Gewürztraminer', 'Chenin Blanc', 'Viognier', 'Albariño'];
...
export default function WhiteWinesPage() {
  ...
  const filteredProducts = whiteWines.filter(product => {
    // Filtro por preço
  ...
  return (
    <main className="container mx-auto px-4 py-8 mt-[100px] md:mt-[120px]">
      {/* Cabeçalho da página */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Vinhos Brancos</h1>
        <p className="text-gray-600">
          Descubra nossa seleção de vinhos brancos premium, desde Chardonnay frutados até Riesling aromáticos.
        </p>
      </div>
