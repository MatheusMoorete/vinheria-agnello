/**
 * Página de Listagem de Kits e Presentes
 * 
 * Esta página exibe todos os kits e presentes disponíveis na loja,
 * com opções de filtragem por preço, tipo de kit, ocasião e avaliação,
 * além de ordenação por relevância, preço e avaliação.
 * 
 * Funcionalidades:
 * - Listagem de produtos com paginação
 * - Filtros por preço, tipo de kit, ocasião e avaliação
...
// Dados mockados de kits e presentes
const giftSets: Product[] = [
  {
    ...
    oldPrice: 699.90,
    image: defaultImage,
    slug: 'kit-degustacao-premium',
    type: 'Kit Degustação',
    occasion: 'Especial',
    rating: 4.8,
    description: 'Kit com 6 vinhos premium selecionados de diferentes regiões',
    isBestSeller: true
  },
  {
    id: '2',
    name: 'Duo Champagne Luxo',
    price: 899.90,
    image: defaultImage,
    slug: 'duo-champagne-luxo',
    type: 'Kit Champagne',
    occasion: 'Celebração',
    rating: 4.9,
    description: 'Duo de champagnes premium com taças exclusivas',
    isNew: true
  },
  {
    id: '3',
    ...
    oldPrice: 499.90,
    image: defaultImage,
    slug: 'kit-harmonizacao',
    type: 'Kit Harmonização',
    occasion: 'Jantar',
    rating: 4.7,
    description: 'Kit com vinhos e produtos gourmet para harmonização'
  },
  {
    id: '4',
    name: 'Cesta Presente Clássica',
    price: 349.90,
    image: defaultImage,
    slug: 'cesta-presente-classica',
    type: 'Cesta',
    occasion: 'Presente',
    rating: 4.6,
    description: 'Cesta com vinho, queijos e acompanhamentos'
  },
  {
    id: '5',
    name: 'Kit Sommelier',
    ...
    rating: 4.8,
    description: 'Kit completo com acessórios para sommelier'
  },
  {
    id: '6',
    name: 'Trio Tintos Especiais',
    price: 499.90,
    image: defaultImage,
    slug: 'trio-tintos-especiais',
    type: 'Kit Vinhos',
    occasion: 'Presente',
    rating: 4.5,
    description: 'Seleção de três vinhos tintos premiados'
  },
  {
    id: '7',
    name: 'Kit Celebração',
    ...
    occasion: 'Celebração',
    rating: 4.7,
    description: 'Kit com espumantes e champagne para celebrações'
  },
  {
    id: '8',
    ...
    occasion: 'Especial',
    rating: 4.9,
    description: 'Cesta luxuosa com vinhos e produtos gourmet selecionados',
    isNew: true
  }
];

// Tipos de kit disponíveis para filtro
const availableTypes = ['Kit Degustação', 'Kit Champagne', 'Kit Harmonização', 'Cesta', 'Kit Acessórios', 'Kit Vinhos', 'Kit Espumantes'];

// Ocasiões disponíveis para filtro
const availableOccasions = ['Especial', 'Celebração', 'Jantar', 'Presente', 'Profissional'];
...
export default function GiftSetsPage() {
  ...
  const handleFilterChange = (filterType: keyof FilterOptions, value: unknown) => {
    setFilters(prev => {
      ...
      if (filterType === 'types' || filterType === 'occasions') {
  ...
  const filteredProducts = giftSets.filter(product => {
    // Filtro por preço
  ...
  return (
    <main className="container mx-auto px-4 py-8 mt-[180px] md:mt-[220px]">
      {/* Cabeçalho da página */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Kits e Presentes</h1>
        <p className="text-gray-600">
          Explore nossa seleção especial de kits e presentes, perfeitos para todas as ocasiões e celebrações.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="hidden md:block w-64 flex-shrink-0">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {/* Filtro por tipo */}
            <div className="mb-6">
              <h3 className="font-medium mb-3">Tipo de Kit</h3>
            ...
            {/* Filtro por ocasião */}
            <div className="mb-6">
              <h3 className="font-medium mb-3">Ocasião</h3>
              <div className="space-y-2">
